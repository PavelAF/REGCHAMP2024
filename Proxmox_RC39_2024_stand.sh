...
qm create 101 --name "RTR-HQ" --cores 4 --memory 4096 --startup order=2,up=20,down=0 --net0 e1000,bridge=vmbr1 --net1 e1000,bridge=vmbr2 --serial0 socket --acpi 0 --ostype l26 --scsihw virtio-scsi-single
qm importdisk 101 vESR.vmdk $STORAGE --format qcow2 
qm set 101 --scsi0 $STORAGE:vm-101-disk-0 --boot order=scsi0
echo "RTR-HQ is done!!!"

qm create 106 --name "RTR-BR" --cores 4 --memory 40966 --startup order=2,up=20,down=0 --net0 e1000,bridge=vmbr11 --net1 e1000,bridge=vmbr12 --serial0 socket --acpi 0 --ostype l26 --scsihw virtio-scsi-single
...
qm create 102 --name "SW-HQ" --cores 1 --memory 1024 --startup order=3,up=15,down=30 --net0 virtio,bridge=vmbr2 --net1 virtio,bridge=vmbr4 --net2 virtio,bridge=vmbr5 --net3 virtio,bridge=vmbr3 --serial0 socket --agent 1 --ostype l26 --scsihw virtio-scsi-single
qm importdisk 102 ALT_Server.vmdk $STORAGE --format qcow2 
qm set 102 --scsi0 $STORAGE:vm-102-disk-0 --boot order=scsi0
echo "SW-HQ is done!!!"

qm create 103 --name "SRV-HQ" --cores 2 --memory 4096 --startup order=4,up=15,down=60 --net0 virtio,bridge=vmbr3 --serial0 socket --agent 1 --ostype l26 --scsihw virtio-scsi-single
...
qm create 107 --name "SW-BR" --cores 1 --memory 1024 --startup order=3,up=15,down=30 --net0 virtio,bridge=vmbr12 --net1 virtio,bridge=vmbr13 --net2 virtio,bridge=vmbr14 --serial0 socket --agent 1 --ostype l26 --scsihw virtio-scsi-single
qm importdisk 107 ALT_Server.vmdk $STORAGE --format qcow2 
qm set 107 --scsi0 $STORAGE:vm-107-disk-0 --boot order=scsi0
echo "SW-BR is done!!!"

qm create 108 --name "SRV-BR" --cores 2 --memory 2048 --startup order=4,up=15,down=60 --net0 virtio,bridge=vmbr13 --serial0 socket --agent 1 --ostype l26 --scsihw virtio-scsi-single
...
qm create 104 --name "CLI-HQ" --cores 2 --memory 2048 --startup order=5,up=20,down=30 --net0 virtio,bridge=vmbr4 --serial0 socket --agent 1 --ostype l26 --scsihw virtio-scsi-single
qm importdisk 104 ALT_Workstation.vmdk $STORAGE --format qcow2
qm set 104 --scsi0 $STORAGE:vm-104-disk-0 --boot order=scsi0
echo "CLI-HQ is done!!!"

qm create 105 --name "CICD-HQ" --cores 2 --memory 2048 --startup order=5,up=20,down=30 --net0 virtio,bridge=vmbr5 --serial0 socket --agent 1 --ostype l26 --scsihw virtio-scsi-single
...
qm create 109 --name "CLI-BR" --cores 2 --memory 2048 --startup order=5,up=20,down=30 --net0 virtio,bridge=vmbr14 --serial0 socket --agent 1 --ostype l26 --scsihw virtio-scsi-single
