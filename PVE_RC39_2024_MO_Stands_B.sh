...
EOF
			...
			ip_e=`dig @resolver1.opendns.com myip.opendns.com +short -4 2>/dev/null`
			ip6_e=`dig @resolver1.ipv6-sandbox.opendns.com myip.opendns.com +short -6 aaaa 2>/dev/null`
